defmodule EnnustusWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EnnustusWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EnnustusWeb.Gettext, "errors", msg, opts)
    end
  end

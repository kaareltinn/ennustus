defmodule FoobarWeb.UserAuthTest do
  use FoobarWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Foobar.Accounts
  alias FoobarWeb.UserAuth
  import Foobar.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FoobarWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FoobarWeb.Endpoint.subscribe(live_socket_id)
